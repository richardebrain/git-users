...
export const UserField = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className='h-16 rounded-2xl  shadow-cardShw bg-[#fefefe]  flex items-center space-x-2 px-4 justify-between dark:shadow-none  dark:bg-bgLightDark' >
            ...
            <input type="text" placeholder="Search GitHub username" onChange={handleUserChange} value={userCtx!.userValue} className='w-full border-none outline-none pl-8 dark:bg-bgLightDark dark:text-stats dark:placeholder:text-stats ' />
            </div>
